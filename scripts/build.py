...
def build(*, source_path: Path, locales_dir: Path, out_dir: Path, download_base: str, include_builtins: bool, codes: list[str] | None, skip_incomplete: bool) -> None:
...
def main() -> None:
    ...
    build(source_path=args.source, locales_dir=args.locales_dir, out_dir=args.out, download_base=args.download_base, include_builtins=args.include_builtins, codes=args.codes, skip_incomplete=args.skip_incomplete)
